...
const Button = (props) => {
  ...
  const btnClasses = clsx(
    ...
    {
      "text-dark-text border-btn-shadow bg-btn-normal active:bg-btn-normal-active": btnType == "primary",
      ...
      "text-white border-btn-shadow-teritiary bg-btn-teritiary active:bg-btn-teritiary-active":
        btnType == "teritiary",
    },
  );
  const btnWdith = clsx({
    "basis-1/4 p-2": btnType == "primary" || btnType == "special",
    "basis-1/2 p-2": btnType == "secondary" || btnType == "teritiary",
  });
